...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.menu.markUnread": "Marcar como não lida",
  "sessions.sidebar.session.menu.markRead": "Marcar como lida",
  ...
  "chat.queuedMessage.title": "Mensagens na fila",
  ...
  "chat.queuedMessage.admissionPending": "Enviando ao servidor…",
  "chat.queuedMessage.admitted": "Na fila do servidor · você pode fechar",
  "chat.queuedMessage.localFallback": "Fila local · mantenha o cliente aberto",
  "chat.queuedMessage.admissionFailed": "Falha ao adicionar à fila",
  "chat.queuedMessage.admissionUnknown": "Resultado desconhecido · pode duplicar, não tente novamente",
  "chat.queuedMessage.retryAdmission": "Tentar adicionar novamente",
  "chat.queuedMessage.restore": "Mover para o compositor",
  "chat.queuedMessage.copy": "Copiar texto",
  "chat.queuedMessage.dismiss": "Dispensar",
  "chat.queuedMessage.copyFailed": "Não foi possível copiar o texto da mensagem",
  "chat.queuedMessage.selectionLimitation": "A admissão no servidor usa as configurações atuais de modelo, agente e variante da sessão",
