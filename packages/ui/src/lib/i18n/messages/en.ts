...
export const dict = {
  ...
  'chat.queuedMessage.admissionPending': 'Sending to server…',
  'chat.queuedMessage.admitted': 'Queued on server · safe to close',
  'chat.queuedMessage.localFallback': 'Local queue · keep client open',
  'chat.queuedMessage.admissionFailed': 'Admission failed',
  'chat.queuedMessage.admissionUnknown': 'Outcome unknown · may duplicate; do not resend',
  'chat.queuedMessage.retryAdmission': 'Retry admission',
  'chat.queuedMessage.restore': 'Move to composer',
  'chat.queuedMessage.copy': 'Copy text',
  'chat.queuedMessage.dismiss': 'Dismiss',
  'chat.queuedMessage.copyFailed': 'Could not copy message text',
  'chat.queuedMessage.selectionLimitation': 'Server admission uses the session’s current model, agent, and variant settings',
